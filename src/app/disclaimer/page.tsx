    ...
    return (
        <div className="min-h-screen bg-white font-sans text-zinc-900">
            ...
            <main className="pt-40 pb-20 container mx-auto px-6 max-w-4xl">
                <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-12">Disclaimer.</h1>
                <div className="space-y-10 text-lg font-medium text-zinc-600 leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">1. No Legal Advice</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">2. Data Accuracy</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">3. Liability</h2>
