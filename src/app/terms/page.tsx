    ...
    return (
        <div className="min-h-screen bg-white font-sans text-zinc-900">
            ...
            <main className="pt-40 pb-20 container mx-auto px-6 max-w-4xl">
                <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-12">Terms of Service.</h1>
                <div className="space-y-10 text-lg font-medium text-zinc-600 leading-relaxed">
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">1. Acceptance of Terms</h2>
                        <p>By accessing PropGoCRM, you agree to be bound by these Terms of Service and all applicable laws and regulations.</p>
                    </section>
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">2. License to Use</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-2xl font-black text-zinc-900 tracking-tight">3. Service Availability</h2>
