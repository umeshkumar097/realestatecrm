...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Master Real Estate Matrix AI",
    locale: "en_US",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Master Real Estate Matrix AI | World-Class Digital Dominance",
    description: "The global gold-standard in high-authority real estate management governance. Powered by Aiclex Labs.",
    images: ["/og-image.png"],
  },
  alternates: {
